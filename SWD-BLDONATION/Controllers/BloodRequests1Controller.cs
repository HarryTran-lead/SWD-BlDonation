...
namespace SWD_BLDONATION.Controllers
{
    ...
    [ApiController]
    public class BloodRequests1Controller : ControllerBase
    {
        private readonly BloodDonationContext _context;

        public BloodRequests1Controller(BloodDonationContext context)
        {
            _context = context;
        }

        // GET: api/BloodRequests1
        [HttpGet]
