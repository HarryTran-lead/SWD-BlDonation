...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=localhost;Initial Catalog=BloodDonation;User ID=sa;Password=sa;Encrypt=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BloodRequest>(entity =>
        {
            ...
            // Removed MedicalHistory, PatientCondition, ReasonForRequest, and UrgencyLevel
            entity.Property(e => e.HealthInfo)
                .HasColumnType("text")
                .HasColumnName("health_info");  // New field for health info
            entity.Property(e => e.Quantity).HasColumnName("quantity");
